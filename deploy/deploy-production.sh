...
ssh "$REMOTE_HOST" "REMOTE_DIR='$REMOTE_DIR' STAGING_PATH='$STAGING_PATH' NETWORK='$REMOTE_NETWORK' PUBLIC_URL='$PUBLIC_URL' MODE='$MODE' RELEASE_ID='$RELEASE_ID' bash -s" <<'REMOTE'
set -euo pipefail
