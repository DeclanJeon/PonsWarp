...
export const CHUNK_SIZE_INITIAL = 128 * 1024; // 128KB, still below common SCTP message limits
export const CHUNK_SIZE_MAX = 128 * 1024; // fixed until adaptive sender is re-enabled
