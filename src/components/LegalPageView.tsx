    ...
    sections: [
      {
        ...
        body: [
          ...
          '아래 문서는 실제 사업자 정보와 최종 법률 검토를 반영해 게시되어야 합니다.',
        ],
      },
    ],
  },
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          '요청은 문의 페이지의 개인정보 요청 채널로 접수합니다. 실제 운영 전 담당자 연락처를 확정해야 합니다.',
        ],
      },
    ],
  },
  ...
  '/refund': {
    ...
    sections: [
      ...
      },
      {
        title: '월 구독',
        body: [
          '구독은 다음 결제 주기 전 해지할 수 있어야 하며, 해지 후 남은 기간 동안 제공 범위는 정책에 따라 안내해야 합니다.',
          '환불 불가 조건이나 부분 환불 조건은 결제 전 화면에 명확히 표시되어야 합니다.',
        ],
      },
    ],
  },
  '/commerce-disclosure': {
    ...
    sections: [
      ...
      },
      {
        title: '게시 전 확인',
        body: [
          '전자상거래 운영자는 소비자가 사업자의 신원 정보를 쉽게 알 수 있도록 표시해야 합니다.',
          '실제 결제 오픈 전 위 항목을 실제 사업자 정보로 교체해야 합니다.',
        ],
      },
    ],
  },
