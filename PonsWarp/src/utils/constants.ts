...
export const MAX_BUFFERED_AMOUNT = 24 * 1024 * 1024; // 24MB hard stop
export const LOW_WATER_MARK = 3 * 1024 * 1024; // 3MB drain — refill sooner
export const HIGH_WATER_MARK = 12 * 1024 * 1024; // 12MB fill target
